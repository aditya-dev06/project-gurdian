...
def get_gemini_kanji_card(api_key, jlpt_level="N5", excluded_list=None):
    ...
    fallback_pools = {
        "N5": [
            {"kanji": "日", "meaning": "day, sun, Japan", "onyomi": "ニチ, ジツ", "kunyomi": "ひ, び, か", "stroke_count": 4, "example_ja": "日本にいきたいです。", "example_en": "I want to go to Japan.", "kanji_yomi": "ひ", "kanji_romaji": "hi", "example_yomi": "にほん に いきたい です。", "example_romaji": "nihon ni ikitai desu."},
            {"kanji": "本", "meaning": "book, origin, main", "onyomi": "ホン", "kunyomi": "もと", "stroke_count": 5, "example_ja": "日本語をべんきょうします。", "example_en": "I study Japanese.", "kanji_yomi": "ほん", "kanji_romaji": "hon", "example_yomi": "にほんご を べんきょう します。", "example_romaji": "nihongo o benkyou shimasu."},
            {"kanji": "人", "meaning": "person, human", "onyomi": "ジン, ニン", "kunyomi": "ひと", "stroke_count": 2, "example_ja": "あの人はだれですか。", "example_en": "Who is that person?", "kanji_yomi": "ひと", "kanji_romaji": "hito", "example_yomi": "あの ひと は だれ です か。", "example_romaji": "ano hito wa dare desu ka."},
            {"kanji": "学", "meaning": "study, learning, science", "onyomi": "ガク", "kunyomi": "まな-ぶ", "stroke_count": 8, "example_ja": "学生ですか。", "example_en": "Are you a student?", "kanji_yomi": "まなぶ", "kanji_romaji": "manabu", "example_yomi": "がくせい です か。", "example_romaji": "gakusei desu ka."},
            {"kanji": "生", "meaning": "life, birth, genuine", "onyomi": "セイ, ショウ", "kunyomi": "い-きる, う-む, なま", "stroke_count": 5, "example_ja": "先生、こんにちは。", "example_en": "Hello, teacher.", "kanji_yomi": "なま", "kanji_romaji": "nama", "example_yomi": "せんせい、こんにちは。", "example_romaji": "sensei, konnichiwa."},
